...
export const OperativoTerceros = () => {
  ...
  return (
    <div className="space-y-4" data-testid="operativo-terceros">
      <div>
        <h2 className="text-2xl font-bold tracking-tight">Reporte de servicios</h2>
        <p className="text-sm text-muted-foreground">Operativo, tiempos muertos y balance de terceros</p>
      </div>
