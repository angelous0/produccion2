  ...
  const fetchRegistro = async () => {
    ...
    try {
      ...
      setFormData({
        ...
        fecha_envio_tienda_auto: registro.fecha_envio_tienda_auto ?? undefined,
      });
