export { RegistroHeader } from './RegistroHeader';
export { RegistroDatosCard } from './RegistroDatosCard';
export { RegistroTallasCard } from './RegistroTallasCard';
export { RegistroMovimientosCard } from './RegistroMovimientosCard';
