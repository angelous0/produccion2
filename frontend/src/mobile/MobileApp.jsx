...
import { MobileCortesSinColores } from './pages/CortesSinColores';
import { MobileFalladosTablero } from './pages/FalladosTablero';
  ...
  return (
    <Routes>
      ...
      <Route element={
        ...
        <Route path="cortes-sin-colores" element={<MobileCortesSinColores />} />
        <Route path="fallados" element={<MobileFalladosTablero />} />
